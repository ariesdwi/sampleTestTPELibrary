  ...
  List<AccountSection> _buildSections() {
    return [
      AccountSection(items: [
        ...
        AccountItem(icon: Icons.notifications_active, label: "Manage Notification"),
      ]),
      AccountSection(items: [
      ...
      AccountSection(items: [
        ...
        AccountItem(icon: Icons.credit_card, label: "Kartu Debit & Kartu Kredit"),
        AccountItem(icon: Icons.compare_arrows, label: "Jenis & Limit Transaksi"),
      ...
      AccountSection(items: [
        AccountItem(icon: Icons.palette, label: "Theme"),
      ]),
      AccountSection(items: [
        AccountItem(icon: Icons.logout, label: "Logut"),
      ]),
    ];
  }
}
